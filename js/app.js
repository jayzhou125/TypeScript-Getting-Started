...
var Utility = (function () {
    ...
    Utility.getInput = function (elementID) {
...
var Game = (function () {
    ...
    Game.prototype.calculateScore = function () {
        var score = 0;
        for (var i = 1; i <= this.problemCount; i++) {
            var answer = Number(Utility.getInput('answer' + i));
...
document.getElementById('startGame').addEventListener('click', function () {
    ...
    var problemCount = Number(Utility.getInput('problemCount'));
    var factor = Number(Utility.getInput('factor'));
